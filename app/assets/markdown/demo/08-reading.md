...
Clear typography that adapts to your device and screen size, a calm layout, and minimal distractions make reading a PrivatePress a pleasure. 
...
On devices with a hardware keyboard attached you can also simply hit the arrow keys to move between pages. Just press  `→` to turn to the next page and `←` to go back. When you reach the end of the book, PrivatePress will return you to the table of contents.
